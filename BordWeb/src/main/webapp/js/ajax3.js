...
let fields = ['userId', 'userName', 'responsibility', 'img'];
...
document.getElementById("addBtn").addEventListener("click", function() {
	...
	// let newMem = { userId: document.getElementById("uid").value, userName: document.getElementById("uname").value, userPw: document.getElementById("upw").value, responsibility: "User" };
